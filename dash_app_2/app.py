...
def handle_dropdowns(
    ...
    select_directors, select_actors, select_movies, click_director, click_actor, click_movie, director_options, actor_options, genre_options,
    ...
    if trigger == 'graph_directors' and click_director:
